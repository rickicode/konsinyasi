export type User = { id: string | number; email: string; name: string; role: string; status?: string };
let authMeCache:
| {
...
/** Clear the short-lived /api/auth/me cache, e.g. after sign out. */
export function clearCurrentUserCache(): void {
  authMeCache = undefined;
}
